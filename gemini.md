...
For the current SG@SG workflow, use these repo-native docs instead of maintaining a separate Gemini-specific runbook:

- [AGENTS.md](/Users/chrisroyce/Developer/Personal_Projects/website-sg-sg/AGENTS.md)
- [README.md](/Users/chrisroyce/Developer/Personal_Projects/website-sg-sg/README.md)
...
Use this template when building a reviewed payload:
